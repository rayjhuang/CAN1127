...
#ifdef CONFIG_FPGA // 25mV/LSB, less linearity
...
#define SET_2V7_ON()            (PWRCTL |= 0xC0) // turn on DP 2.7V driver
#define SET_2V7_OFF()           (PWRCTL &=~0xC0) // turn off DP 2.7V driver
#define SET_2V7_SHORT_OFF()     (PWRCTL &=~0xC8) // turn off DP 2.7V driver and DP/DN short
#define SET_2V7_DNDWN_OFF()     (PWRCTL &=~0xD0) // turn off DP 2.7V driver and DN pulldown
#define SET_DPDN_ALL_OFF()      (PWRCTL &=~0xD8) // clear DPDN_*
...
#define INIT_ANALOG_IFB_CONNECTED() (REGTRM5|= 0x01)
...
#define COMP_SWITCH_TOGGLE()        (CMPOPT ^= 0x80)
...
#define INIT_DAC_CHANNELS()  (DACEN  = 0xC8)
...
#define ENABLE_SR()      (SRCCTL |= 0x30) // SR_EN, SR_CCMF_ENB
#define INIT_ANALOG_SR() (SRCTL   = 0x08, REGTRM5 |= 0xC8) // SR_PWRON,REGTRM[47,46,43]
