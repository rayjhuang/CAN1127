 ...
 *  DESCRIPTION                                                        
 *  -----------
 *  CAN1127 proprietary registers
 *                                                                            
 *  Ver.  Date(Y-M-D)  Author  Description                             
 *  ----  -----------  ------  -----------
 *  1.0   2018-01-26   Ray     Initial version                         
 *        2022-09-16   Ray     copy from ../../can1124/fw/
 *
 *  All Rights Are Reserved
 ******************************************************************************/
#ifndef __CAN1127_REG_H__
#define __CAN1127_REG_H__
...
#define _REGTRM0 0xA1
#define _REGTRM1 0xA2
#define _REGTRM2 0xA3
#define _REGTRM3 0xA4
#define _REGTRM4 0xA5
